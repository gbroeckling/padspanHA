...
export const HELP = {
  ...
  traceback_overview: {
    ...
    body: [
      ...
      "💡 DEVICES — shown when Full house activity is on. Turn it on and the whole house plays back too: every device your Atlas shows, as it was at each moment of the chosen period — lights, doors, windows, locks, motion, and temperature, humidity and air-quality readings (a reading counts when what the map shows changes: a whole degree, a whole percent, an air-quality band). Every tracked object plays along. Each device that changed at the moment on screen is ringed on the map and named above it, and the list under the map shows every change — tap one to jump there. House history comes from Home Assistant's own recorder, so it reaches back as far as your recorder keeps (10 days by default); beacon history keeps 7 days.",
    ],
  },
