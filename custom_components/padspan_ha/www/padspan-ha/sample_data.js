...
export const SAMPLE_SNAPSHOT = {
  ...
  objects: {
    list: [
      ...
      // --- iBeacon (stable UUID survives MAC rotation — beacons, key finders, HA Companion App; never an AirTag) ---
      { key: "ibeacon:f7826da6-4fa2-4e98-8024-bc5b71e0893e:1:2", kind: "ibeacon", address: "ibeacon:f7826da6-4fa2-4e98-8024-bc5b71e0893e:1:2", all_addresses: ["61:A3:FC:22:D1:88", "72:B4:ED:33:C2:99"], name: "Key finder (Bag)", user_label: "Key finder (Bag)", identified: true, rssi: -67, age_s: 6, room: "Kitchen", sources: ["kitchen_hub"], company_name: "Apple", device_type: "iBeacon", service_names: [], service_uuid_map: {}, ibeacon_uuid: "f7826da6-4fa2-4e98-8024-bc5b71e0893e", ibeacon_major: 1, ibeacon_minor: 2 },
